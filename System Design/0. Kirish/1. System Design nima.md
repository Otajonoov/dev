...
|----------|-----------------|-------------------|
| **WAL** (Write-Ahead Log) | Avval log'ga yoziladi, keyin data page'ga; crash bo'lsa log'dan tiklanadi | PostgreSQL — batafsil: [WAL darsi](<../../7. ML Engineer/9. Database/2. Postgres/2. Advanced PostgreSQL/10. WAL — Write-Ahead Log.md>) |
